...
interface SoilFoundationsPageProps {
	params: {
		locale: Locale
		country: string
	}
...
const calculatorConfigs = [
	...
	},
	{
		...
		description: 'Convert foundation sizing into concrete quantities for budgeting.',
	},
]
...
const schemaDescription =
	'Educational overview of soil properties, foundation types, and how geotechnical assumptions influence early design estimates.'

export async function generateMetadata({
	params,
}: SoilFoundationsPageProps): Promise<Metadata> {
	...
	return {
		...
		openGraph: {
			title: 'Soil & Foundations – Educational Overview',
			description: schemaDescription,
			url: `https://first-calc.com${basePath}/standards/national/us/soil-foundations`,
			type: 'article',
		},
	}
}

export default async function SoilFoundationsPage({
	params,
}: SoilFoundationsPageProps) {
	const { locale, country } = params
	...
	const schema = {
		...
		'@type': 'TechArticle',
		headline: 'Soil & Foundations – Educational Overview',
		description: schemaDescription,
		inLanguage: locale,
		about: ['soil mechanics', 'foundations', 'geotechnical engineering', 'bearing capacity'],
		isPartOf: {
			'@type': 'CollectionPage',
		...
		<>
			...
			<PageContainer>
				...
				<div className="prose prose-lg max-w-none text-gray-700 mb-8">
					<p>
						Understanding soil properties and foundation types helps bridge the gap
						between early estimates and detailed engineering design. This page
						explains how soil assumptions influence foundation selection and sizing
					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
						<div className="bg-white border border-gray-200 rounded-lg p-4">
							...
							<p className="text-gray-700 text-sm">
								Commonly discussed soil categories include sand, clay, gravel,
								and rock. Each behaves differently under load: sand drains well but
								can shift, clay holds water and can expand or contract, gravel is
								strong and stable, and rock provides the strongest foundation.
							</p>
						</div>
						<div className="bg-white border border-gray-200 rounded-lg p-4">
							<h3 className="text-lg font-semibold text-gray-900 mb-2">
				...
				<section className="mb-8">
					...
					<div className="bg-blue-50 border border-blue-200 rounded-lg p-5 text-blue-900 mb-4">
						...
						<p>
							Shallow foundations (strip footings, slab-on-grade) work well for
							moderate loads on stable soils. Deep foundations (piles, caissons) are
							typically considered for weak soils, high groundwater, or strict
