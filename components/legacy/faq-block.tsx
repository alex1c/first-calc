...
import type { FAQItem } from '@/lib/legacy/contentGenerators'

interface LegacyFaqBlockProps {
	faq: FAQItem[]
	title?: string
}

/**
 * FAQ block component for legacy pages (accordion style)
 */
export function LegacyFaqBlock({
	faq,
